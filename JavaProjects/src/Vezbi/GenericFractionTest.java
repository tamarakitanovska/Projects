...
class GenericFraction<T extends Number,U extends Number>{
    ...
    public GenericFraction<Double, Double> add(GenericFraction<? extends Number, ? extends Number> gf) throws ZeroDenominatorException {
        GenericFraction<Double, Double> result = null;
            result = new GenericFraction<Double, Double>(numerator.doubleValue() * gf.denominator.doubleValue() + denominator.doubleValue() , denominator.doubleValue() * gf.denominator.doubleValue());
        return result;
    }
