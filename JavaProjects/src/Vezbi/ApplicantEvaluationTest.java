    ...
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluation {
            ...
            case MORE_EXPERIENCE_AND_MORE_CREDIT_SCORE :
                return new Evaluator() {
                    ...
                    public boolean evaluate(Applicant applicant) {
                        if (applicant.getEmploymentYears() >= 10 && applicant.getCreditScore() >= 500)
                            return true;
                        return false;
                    }
                };
        ...
        case NO_CRIMINAL_RECORD_AND_MORE_CREDIT_SCORE :
                return new Evaluator() {
                    @Override
                    public boolean evaluate(Applicant applicant) {
                        if (!applicant.hasCriminalRecord() && applicant.getCreditScore() >= 500)
                            return true;
                        return false;
                    }
                };
        ...
        case NO_CRIMINAL_RECORD_AND_MORE_EXPERIENCE :
                return new Evaluator() {
                    @Override
                    public boolean evaluate(Applicant applicant) {
                        if (!applicant.hasCriminalRecord() && applicant.getEmploymentYears() >= 10)
                            return true;
                        return false;
                    }
                };
